...
<div class="bg-white max-w-screen-xl mx-auto p-5 sm:p-10 md:p-16">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        ...
        <div class="rounded overflow-hidden shadow-lg flex flex-col">
            ...
            <div class="relative"><a href="#">
                ...
                <a href="{{url('add_cart',$product->id)}}" class="add-to-cart" data-id="{{$product->id}}">
                    <div class="text-xs absolute top-0 right-0 bg-black px-4 py-2 text-white mt-3 mr-3 ">
            ...
            <div class="px-6 py-4 mb-auto">
                <a href="#"
                    class="text-black font-bold text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">
                    {{$product->name}}</a>
            ...
            <div class="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                ...
                <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                    ...
                    <span class="ml-1">Stock : {{$product->sku}}</span>
                </span>
            </div>
        </div>
        @endforeach
...
<script src="https://kit.fontawesome.com/7acb5e9785.js" crossorigin="anonymous"></script>
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addToCartLinks.forEach(link => {
            link.addEventListener('click', function (e) {
                ...
                const productId = this.dataset.id; // Ambil ID produk
