...
<div class ="md:container md:mx-auto px-20 pt-5 pb-5 bg-neutral-700 rounded-lg mt-4">
    <div class="grid-rows-5">
        <div class="border-b-2 border-neutral-100 px-3 py-2 dark:border-white/20">
            <h2 class="mb-2 text-xl text-white font-medium leading-tight">Edit Product</h2>
        </div>
        <form enctype="multipart/form-data" action="{{route('admin.update',$product->id)}}" method="post">
            ...
            <div class="mb-6 mt-3">
                ...
                <input type="text" value="{{ old('name', $product->name) }}" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('name')
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{ old('sku',$product->sku) }}" id="sku" name="sku" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('sku')
                <p class="text-white">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{ old('price',$product->price) }}" id="price" name="price" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('price')
                <p class="text-white">{{$message}}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <textarea class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="description" cols="30" rows="2">{{ old('description',$product->description) }}</textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                @if ($product->image != "")
                    <img class="w-20 pt-2" src="{{asset('uploads/product/'.$product->image)}}" alt="">
